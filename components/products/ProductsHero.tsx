  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 70% 60% at 50% 40%, rgba(201,150,58,0.05) 0%, transparent 68%)',
        }}
      />
          ...
          {[...Array(6)].map((_, i) => {
            ...
            return (
              <motion.ellipse
                ...
                transition={{ duration: 5 + i * 0.6, repeat: Infinity, ease: 'easeInOut', delay: i * 0.25 }}
              />
            );
          })}
        </svg>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-10 text-center py-20">
        <motion.div
        ...
        >
          ...
          <span className="eyebrow">Sintered NdFeB</span>
          <div className="gold-line w-10" />
        </motion.div>
        ...
        >
          Product <span className="gold-text italic">Specifications</span>
        </motion.h1>
        ...
        >
          High-performance sintered NdFeB permanent magnets for advanced industrial systems.
        </motion.p>
      </div>
    </section>
  );
